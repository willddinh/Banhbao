 ...
 * Generated for Laravel 5.1.38 (LTS) on 2016-06-13.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Fully\Console\Kernel::call($command, $parameters);
        }
    ...
    class VideoApi extends \Sseffa\VideoApi\Facades\VideoApi{
        ...
        public static function setType($type){
            return \Sseffa\VideoApi\VideoApi::setType($type);
        }
        
    }


    class Feeder extends \Fully\Feeder\Facade\Feeder{
         ...
         * @static 
         */
        public static function feed($entries, $settings = null){
            return \Fully\Feeder\Feeder::feed($entries, $settings);
        }
        
    }


    class Search extends \Fully\Search\Facade\Search{
        ...
        public static function search($search){
            return \Fully\Search\Search::search($search);
        }
