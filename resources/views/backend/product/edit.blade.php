...
<div class="container">
    ...
    <div class="control-group {!! $errors->has('title') ? 'has-error' : '' !!}">
        ...
        <div class="controls">
            {!! Form::text('title', $product->title, array('class'=>'form-control', 'id' => 'title', 'placeholder'=>'Title', 'value'=>Input::old('title'))) !!}
    ...
    <div class="control-group {!! $errors->has('title') ? 'has-error' : '' !!}">
        ...
        <div class="controls">
            {!! Form::text('price', $product->price, array('class'=>'form-control numeric', 'id' => 'price', 'placeholder'=>'Price', 'value'=>Input::old('price'))) !!}
