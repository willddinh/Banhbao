...
<head>
    ...
    <script src="{!! url('backend/plugins/numeric/jquery_numeric.min.js') !!}" type="text/javascript"></script>
    <script src="{{ url('kendo/js/kendo.all.min.js') }}"></script>
{{--    <script src="{{ url('kendo/js/kendo.treeview.min.js') }}"></script>--}}
    <script src="{{ url('kendo/js/cultures/kendo.culture.vi-VN.min.js') }}"></script>
