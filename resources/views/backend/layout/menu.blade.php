...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview {{ setActive('admin/category*') }}"><a href="#"> <i class="fa fa-bookmark"></i> <span>Category</span>
                    <i class="fa fa-angle-down pull-right"></i> </a>
                <ul class="treeview-menu">
                    <li><a href="{{ url(getLang() . '/admin/category') }}"><i class="fa fa-folder"></i> All Category</a>
                    </li>
                    <li><a href="{{ url(getLang() . '/admin/category/create') }}"><i class="fa fa-plus-square"></i> Add Category</a>
                    </li>
                </ul>
            </li>
