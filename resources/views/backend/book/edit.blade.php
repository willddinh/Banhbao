...
@section('content')
    ...
    <section class="content-header">
        <h1> Book <small> | Update Book</small> </h1>
        <ol class="breadcrumb">
            <li><a href="{!! url(getLang() . '/admin/book') !!}"><i class="fa fa-book"></i> Book</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-10">
            {!! Form::open( array( 'route' => array(getLang(). '.admin.book.update', $book->id), 'method' => 'PATCH', 'files'=>true)) !!}
            <!-- Title -->
                <div class="control-group {!! $errors->has('title') ? 'has-error' : '' !!}">
                    <label class="control-label" for="title">Title</label>

                    <div class="controls">
                        {!! Form::text('title', $book->entity->title, array('class'=>'form-control', 'id' => 'title', 'placeholder'=>'Title', 'value'=>Input::old('title'))) !!}
                ...
                <div class="control-group {!! $errors->has('isbn') ? 'has-error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::text('isbn', $book->isbn, array('class'=>'form-control', 'id' => 'isbn', 'placeholder'=>'isbn', 'value'=>Input::old('isbn'))) !!}
                ...
                <div class="control-group {!! $errors->has('size') ? 'has-error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::text('size', $book->size, array('class'=>'form-control', 'id' => 'size', 'placeholder'=>'size', 'value'=>Input::old('size'))) !!}
                ...
                <div class="control-group {!! $errors->has('page_num') ? 'has-error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::text('page_num', $book->page_num, array('class'=>'form-control', 'id' => 'page_num', 'placeholder'=>'Number of pages', 'value'=>Input::old('page_num'))) !!}
                        @if ($errors->first('size'))
                ...
                <div class="control-group {!! $errors->has('title') ? 'has-error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::text('price', $book->entity->price, array('class'=>'form-control numeric', 'id' => 'price', 'placeholder'=>'Price', 'value'=>Input::old('price'))) !!}
                ...
                <div class="control-group {!! $errors->has('title') ? 'has-error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::text('discount', $book->discount, array('class'=>'form-control numeric', 'id' => 'discount', 'placeholder'=>'Discount', 'value'=>Input::old('discount'))) !!}
                ...
                <div class="control-group {!! $errors->has('rent_price') ? 'has-error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::text('rent_price', $book->rent_price, array('class'=>'form-control numeric', 'id' => 'rent_price', 'placeholder'=>'Discount', 'value'=>Input::old('rent_price'))) !!}
                ...
                <div class="control-group {!! $errors->has('title') ? 'has-error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::text('external_url', $book->external_url, array('class'=>'form-control', 'id' => 'external_url', 'placeholder'=>'Discount', 'value'=>Input::old('external_url'))) !!}
                ...
                <div class="control-group {!! $errors->has('author') ? 'error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::select('author', $authors, $book->author_id, array('class' => 'form-control', 'value'=>Input::old('author'))) !!}
                ...
                <div class="control-group {!! $errors->has('publisher') ? 'error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::select('publisher', $publishers, $book->publisher_id, array('class' => 'form-control', 'value'=>Input::old('publisher'))) !!}
                ...
                <div class="control-group {!! $errors->has('category') ? 'error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::select('category', $categories, $book->category_id, array('class' => 'form-control', 'value'=>Input::old('category'))) !!}
                ...
                <div class="control-group {!! $errors->has('subCategories') ? 'error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::select('subCategories[]', $subCategories, $book->entity->subCategories()->lists('sub_categories.id')->toArray(), array('multiple'=>'true','class' => 'form-control', 'value'=>Input::old('subCategories'))) !!}
                ...
                <div class="control-group {!! $errors->has('content') ? 'has-error' : '' !!}">
                    ...
                    <div class="controls">
                        {!! Form::textarea('content', $book->content, array('class'=>'form-control', 'id' => 'content', 'placeholder'=>'Content', 'value'=>Input::old('content'))) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="control-group {!! $errors->has('meta_description') ? 'has-error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::text('meta_description', $book->meta_description, array('class'=>'form-control', 'id' => 'meta_description', 'placeholder'=>'Meta Description', 'value'=>Input::old('meta_description'))) !!}
                                    ...
                                    <div class="control-group {!! $errors->has('meta_keywords') ? 'has-error' : '' !!}">
                                        ...
                                        <div class="controls">
                                            {!! Form::textarea('meta_keywords', $book->meta_keywords, array('class'=>'form-control', 'id' => 'meta_keywords', 'placeholder'=>'Meta Keywords', 'value'=>Input::old('meta_keywords'))) !!}
                ...
                <div class="fileinput fileinput-new control-group {!! $errors->has('image') ? 'has-error' : '' !!}" data-provides="fileinput">
                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                        <img data-src="" {!! (($book->file_name) ? "src='".$book->getGoogleImage()."'" : null) !!} alt="...">
                    </div>
                    ...
                    <div class="control-group {!! $errors->has('is_published') ? 'has-error' : '' !!}">
                        ...
                        <div class="controls">
                            <label class="">{!! Form::checkbox('is_published', 'is_published',$book->is_published) !!} Publish ?</label>
