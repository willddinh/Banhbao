    ...
    <form class="form-horizontal" action="{{ URL::route('account.register.post') }}" method="POST">
        ...
        <div class="form-group{!! ($errors->has('first_name')) ? ' has-error' : '' !!}">
            ...
            <div class="col-lg-3 col-md-4 col-sm-5 col-xs-10">
                ...
                {!! ($errors->has('first-name') ? $errors->first('first-name') : '') !!}
            </div>
        </div>
        ...
        <div class="form-group{!! ($errors->has('last_name')) ? ' has-error' : '' !!}">
            ...
            <div class="col-lg-3 col-md-4 col-sm-5 col-xs-10">
                ...
                {!! ($errors->has('last-name') ? $errors->first('last-name') : '') !!}
            </div>
        </div>
        ...
        <div class="form-group{!! $errors->has('password_confirmation') ? ' has-error' : '' !!}">
            ...
            <div class="col-lg-3 col-md-4 col-sm-5 col-xs-10">
                <input name="confirm_password" id="confirm_password" value="" type="password" class="form-control" placeholder="Confirm Password">
