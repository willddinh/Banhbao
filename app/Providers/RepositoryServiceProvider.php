...
use Fully\Repositories\TreeCategory\CacheDecorator as TreeCategoryCacheDecorator;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        // tree-category
        $app->bind('Fully\Repositories\TreeCategory\TreeCategoryInterface', function ($app) {
