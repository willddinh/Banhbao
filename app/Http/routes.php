...
{
    return View::make('frontend.user.reset.begin');
});
...
{
    return View::make('frontend.user.wait');
});
...
Route::group(array('prefix' => LaravelLocalization::getCurrentLocale(), 'before' => array('localization', 'before')), function () {
    ...
    //frontend register
    Route::get('/register', ['as' => 'account.register', 'uses' => 'UserController@register']);
    Route::post('/register', array('as' => 'account.register.post', 'uses' => 'UserController@postRegister'));
    //frontend login
    Route::get('/login', ['as' => 'account.login', 'uses' => 'UserController@login']);
    Route::post('/login', array('as' => 'account.login.post', 'uses' => 'UserController@postLogin'));
    ...
    // product
    Route::get('/product', array('as' => 'dashboard.product', 'uses' => 'ProductController@index'));
    Route::get('/product/{slug}', array('as' => 'dashboard.product.show', 'uses' => 'ProductController@show'));
...
//        Route::controller( 'tree-category'  , 'TreeCategoryController' );
