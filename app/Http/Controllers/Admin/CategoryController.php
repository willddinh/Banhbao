...
class CategoryController extends Controller
{
    ...
    {
        return view('backend.category.create', ["groups"=>config("common.category_group")]);
    }
    ...
    public function store()
    {
        try {
            ...
            Flash::message('Tạo category thành công');
    ...
    public function edit($id)
    {
        ...
        return view('backend.category.edit', ['category'=>$category, "groups"=>config("common.category_group")] );
    }
    ...
    public function update($id)
    {
        try {
            ...
            Flash::message('Cập nhật category thành công');

            return langRedirectRoute('admin.category.index');
        } catch (ValidationException $e) {
            return langRedirectRoute('admin.category.edit', ['category'=>$id])->withInput()->withErrors($e->getErrors());
        }
    }
    ...
    public function destroy($id)
    {
        ...
        Flash::message('Xóa category was thành công.');
